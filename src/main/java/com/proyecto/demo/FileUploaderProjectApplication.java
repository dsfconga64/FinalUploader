...
public class FileUploaderProjectApplication implements CommandLineRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(FileUploaderProjectApplication.class);
